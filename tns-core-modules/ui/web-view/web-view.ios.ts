...
export class WebView extends WebViewBase {
    ...
    constructor() {
        super();
        let userContentController = WKUserContentController.new();
        ...
        this._wkUController = WKUserContentController.new();
        this._wkUController.addUserScript(wkUScript);            
        configuration.userContentController = this._wkUController;
